...
public abstract class CarController : MonoBehaviour
{
    ...
    protected void OnEachWheel(Action<Wheel> method)
    { // ABSTRACTION
    ...
    protected void UpdateMesh(Wheel wheel)
    { // ABSTRACTION
    ...
    protected virtual void Move(float motorInput, float steerInput, bool handBrakeInput)
    { // ABSTRACTION
